 ...
 */
	public function testFindAllThreaded() {
		...
		$result = $TestModel->find('threaded', array(
			'conditions' => array('Categories.name LIKE' => 'Categories 1%')
		));
		...
		$result = $TestModel->find('threaded', array(
			'conditions' => array('Categories.name LIKE' => 'Categories 3%')
		));
		$expected = array(
			array(
				'Categories' => array(
		...
		$result = $TestModel->find('threaded', array(
			'conditions' => array('Categories.name LIKE' => 'Categories 1.1%')
		));
		$expected = array(
				array('Categories' =>
					array(
		...
		$result = $TestModel->find('threaded', array(
			'fields' => 'id, parent_id, name',
			'conditions' => array('Categories.id !=' => 2)
		));
		$expected = array(
			array(
				'Categories' => array(
