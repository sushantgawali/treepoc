 ...
 */
	public function testExtract() {
		...
		$tree = array(
			array(
				'Categories' => array('name' => 'Categories 1'),
				'children' => array(array('Categories' => array('name' => 'Categories 1.1')))
			),
			array(
				'Categories' => array('name' => 'Categories 2'),
				'children' => array(
					array('Categories' => array('name' => 'Categories 2.1')),
					array('Categories' => array('name' => 'Categories 2.2'))
				)
			),
			array(
				'Categories' => array('name' => 'Categories 3'),
				'children' => array(array('Categories' => array('name' => 'Categories 3.1')))
			)
		);

		$expected = array(array('Categories' => $tree[1]['Categories']));
		$r = Set::extract('/Categories[name=Categories 2]', $tree);
		$this->assertEquals($expected, $r);

		$expected = array(
			array('Categories' => $tree[1]['Categories'], 'children' => $tree[1]['children'])
		);
		$r = Set::extract('/Categories[name=Categories 2]/..', $tree);
		$this->assertEquals($expected, $r);
		...
		$r = Set::extract('/Categories[name=Categories 2]/../children', $tree);
		$this->assertEquals($expected, $r);
		...
		$result = Set::extract('/Categories[id=1]/..', $data);
		$this->assertEquals($expected, $result);
 ...
 */
	public function testExtractParentSelector() {
		...
		$expected = array(array('Categories' => $tree[1]['Categories'], 'children' => $tree[1]['children']));
		$r = Set::extract('/Categories[name=Categories 2]/..', $tree);
		$this->assertEquals($expected, $r);
